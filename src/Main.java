...
public class Main {
    public static void main(String[] args) {
        ...
        methodsSet.compareStudent((Hogwarts) students[0], (Hogwarts) students[2]);
        System.out.println();
        methodsSet.compareStudent((Hogwarts) students[6],(Hogwarts) students[8]);
        System.out.println();
        methodsSet.compareStudent((Hogwarts) students[3],(Hogwarts) students[10]);
        System.out.println();
        methodsSet.compareStudent((Hogwarts) students[3],(Hogwarts) students[6]);
    }
